...
# 参考案例库（在生成GS处置方案时，主动检索是否存在触发原因或玩家类型相似的案例，若有则明确引用）
${hotCasesStr || '暂无参考案例'}
...
4. **GS处置建议**：
   - 具体引导动作。
   - GS 处置方案：先检索上方"参考案例库"，若存在触发原因或玩家类型相似的案例，在处置方案中明确注明"参考了案例[xxx]的处理逻辑"；无相似案例则自行生成。
   - **视角要求（强制）**：以生态运营者的角度出发，把自己想象成这个区服里的另一个玩家去引导他——说话要真实、自然、有人情味，像圈内老玩家之间的交流。
   - **严禁客服腔**：禁止出现"亲爱的玩家"、"感谢您的支持"、"我们会积极优化"、"请您耐心等待"等官方客服话术，禁止任何正式公文式表达。
   - **务必参考背景信息中的"GS 人设和区服生态"**，确保建议的风格语气符合 GS 角色设定。
